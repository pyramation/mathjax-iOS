...
- (id) initWithFrame:(CGRect)frame page:(PageModel*)p {
    ...
    if (self) {
        NSString * html = @"<!DOCTYPE html><html><head><title>MathJax</title><script type=\"text/x-mathjax-config\">MathJax.Hub.Config({tex2jax: {inlineMath: [[\"$\",\"$\"],[\"\\(\",\"\\)\"]]}});</script><script type=\"text/javascript\" src=\"mathjax/MathJax.js?config=TeX-AMS_HTML-full\"></script></head><style>body{font-size: 18pt;}a{text-decoration:none;color:black;}</style><body><br><br>";
        NSString * setHtml = [[[NSString alloc] initWithFormat:@"%@%@<br><br><br><br><br><br></body></html>", html, p.content] autorelease];
